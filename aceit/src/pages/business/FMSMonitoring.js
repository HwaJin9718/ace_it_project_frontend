...
const FMSMonitoring = () => {
  ...
  return (
    <div className="container py-5">
      ...
      <p className="md-9 mb-5">{area_content}</p>
      <div className="row">
        {Object.keys(area_details).map((key, index) => (
          <div key={index} className="container col-md-9 mb-5">
      ...
      <div className="introduction-image-container text-center">
        <img src="/FMS_monitoring.png" alt="회사 이미지" className="introduction-company-image img-fluid" />
      </div>
    </div>
  );
};
