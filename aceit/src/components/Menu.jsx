        ...
        <li ref={scope}>
          ...
          >
            <li className="dropdown-item" style={{ opacity: 0, transform: 'scale(0.3)' }}>
              <Link to="/business/service1" style={{ textDecoration: 'none', color: 'black',padding:'10px' }}>
                Service 1
              </Link>
            </li>
            <li className="dropdown-item" style={{ opacity: 0, transform: 'scale(0.3)' }}>
              <Link to="/business/service2" style={{ textDecoration: 'none', color: 'black',padding:'10px' }}>
                Service 2
              </Link>
            </li>
            <li className="dropdown-item" style={{ opacity: 0, transform: 'scale(0.3)' }}>
              <Link to="/business/service3" style={{ textDecoration: 'none', color: 'black',padding:'10px' }}>
                Service 3
              </Link>
            </li>
          </ul>
